...
void MaquinaT::determinarEventos(ListaD &lista) {
    ...
    while (temp != nullptr) { // Itera a través de la lista mientras el puntero 'temp' no sea nulo.
        ...
        // Generar un carácter aleatorio ('R' o 'E') para el científico
        ...
        if (esPrimo(dato)) { // Llama a la función 'esPrimo' para verificar si 'dato' es primo.
            ...
            if (eventoA == nullptr) { // Comprueba si 'eventoA' no ha sido inicializado.
                eventoA = new Nodo(dato, cientificoAleatorio); // Crea un nuevo nodo 'eventoA'.
                ...
                eventoB = new Nodo(dato, cientificoAleatorio); // Crea un nuevo nodo 'eventoB'.
                ...
                eventoC = new Nodo(dato, cientificoAleatorio); // Crea un nuevo nodo 'eventoC'.
                std::cout << "C, el dato es: " << dato << std::endl; // Imprime el tipo de evento y el dato.
                ...
                std::cout << "[" << eventoA->getDatoNodo() <<"|"<<eventoA->getCientificoNodo()<<"]"<<"->"<< "[" << eventoB->getDatoNodo() <<"|"<<eventoB->getCientificoNodo()<<"]"<<"->"<< "[" << eventoC->getDatoNodo() <<"|"<<eventoC->getCientificoNodo()<<"]"<< std::endl; // Imprime el tipo de evento y el dato.
                std::cout << "\n"; // Salto de línea.
            }
        }
